      ...
      <div className="grid xl:grid-cols-6 lg:grid-cols-5 sm:grid-cols-3 grid-cols-1 xl:gap-[30px] gap-5">
        ...
        >
          <div className="w-[170px] h-[170px] rounded-full bg-white flex justify-center items-center overflow-hidden mb-2">
            <img
              src={`${import.meta.env.VITE_PUBLIC_URL}/images/saller-1.png`}
              alt=""
            />
          </div>
          <Link to="/saller-page">
        ...
        >
          <div className="w-[170px] h-[170px] rounded-full bg-white flex justify-center items-center overflow-hidden mb-2">
            <img
              src={`${import.meta.env.VITE_PUBLIC_URL}/images/saller-2.png`}
              alt=""
            />
          </div>
          <Link to="/saller-page">
        ...
        >
          <div className="w-[170px] h-[170px] rounded-full bg-white flex justify-center items-center overflow-hidden mb-2">
            <img
              src={`${import.meta.env.VITE_PUBLIC_URL}/images/saller-3.png`}
              alt=""
            />
          </div>
          <Link to="/saller-page">
        ...
        >
          <div className="w-[170px] h-[170px] rounded-full bg-white flex justify-center items-center overflow-hidden mb-2">
            <img
              src={`${import.meta.env.VITE_PUBLIC_URL}/images/saller-4.png`}
              alt=""
            />
          </div>
          <Link to="/saller-page">
        ...
        >
          <div className="w-[170px] h-[170px] rounded-full bg-white flex justify-center items-center overflow-hidden mb-2">
            <img
              src={`${import.meta.env.VITE_PUBLIC_URL}/images/saller-5.png`}
              alt=""
            />
          </div>
          <Link to="/saller-page">
        ...
        >
          <div className="w-[170px] h-[170px] rounded-full bg-white flex justify-center items-center overflow-hidden mb-2">
            <img
              src={`${import.meta.env.VITE_PUBLIC_URL}/images/saller-6.png`}
              alt=""
            />
          </div>
          <Link to="/saller-page">
