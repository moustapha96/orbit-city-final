    ...
    return (
        <>
            <SEOHeader
                ...
                keywords="électroménager, tabaski ,promotions, offres spéciales, CCBM Shop, ccbme, appareils électroménagers à prix réduits"
            />
            <Layout>
                            ...
                            <div className="flex-1">
                                <div className="products-sorting w-full bg-white flex flex-col md:flex-row justify-between p-[30px] mb-[40px]">
                                    <p className="font-400 text-[13px]">
                                        ...
                                        {totalProductsTabaski > 0 ? `${startIndex}–${endIndex} sur ${totalProductsTabaski} résultats` : "0 résultat"}
                                    </p>
