...
export default function BannerSecond({ className }) {
  ...
  return (
    <>
      <div
        className={`hero-slider-wrapper w-full xl:h-[733px] h-[500px] md:h-[600px] sm:h-[400px] hidden lg:block hero-slider-wrapper ${
          className || ""
        }`}
      >
            ...
            <SimpleSlider settings={settings} selector={sliderRef}>
              <div className="item w-full xl:h-[733px] md:h-[600px] sm:h-[400px] h-[300px]">
                <div
                  ...
                  style={{
                    backgroundImage: `url('/banner_ccbme_shop_pub.png')`,
              ...
              <div className="item w-full xl:h-[733px] md:h-[600px] sm:h-[400px] h-[300px]">
                <div
                  ...
                  style={{
                    backgroundImage: `url('/banner_ccbme_shop_1.png')`,
                    backgroundRepeat: "no-repeat",
                    backgroundSize: "contain",
                    backgroundPosition: "top center",
                    maxWidth: "100%",
