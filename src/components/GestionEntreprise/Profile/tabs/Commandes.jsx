...
import { getCommandeClientsEntreprise, getCommandeECDVClientsEntreprise, getCommandeOrderClientsEntreprise, setValidationStateCommande } from "../../../../services/entrepriseFunctionService";
...
export default function Commandes({ className }) {
...
import { getCommandeClientsEntreprise, getCommandeECDVClientsEntreprise, setValidationStateCommande } from "../../../../services/entrepriseFunctionService";
...
<<<<<<< HEAD
    ...
    useEffect(() => {
        const fetchOrders = async (id) => {
            setLoading(true);
            try {
                let res = await getCommandeClientsEntreprise(id);
                setOrders(res);
            } catch (error) {
...
=======
    ...
    const fetchCommandeECDV = async (id) => {
        setLoading(true)
        try {
            const res = await getCommandeClientsEntreprise(id);
            console.log("res")
            console.log(res)
            setOrders(res);
        } catch (error) {
